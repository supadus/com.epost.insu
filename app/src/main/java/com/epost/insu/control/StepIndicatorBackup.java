...
public class StepIndicatorBackup extends FrameLayout {

    private final int defaultStep = 5;
    private final int defaultSelectedIndex = 0;
    private final int defaultLineSpaceWidth = CommonFunction.CF_convertDipToPixel(getContext(),7);
     ...
     */
    public StepIndicatorBackup(Context context){
        super(context);
        setInit();
        setUIControl();
    }
     ...
     */
    public StepIndicatorBackup(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private View getLineView(){
        ...
        LayoutParams tmp_lp = new LayoutParams(stepSize*stepCount+defaultLineSpaceWidth*(stepCount-1)-CommonFunction.CF_convertDipToPixel(getContext(),5), lineThickness);
